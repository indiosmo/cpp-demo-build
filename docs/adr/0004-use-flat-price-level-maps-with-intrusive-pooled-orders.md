# 4. Use flat price-level maps with intrusive pooled orders
...
[`0004-use-flat-price-level-maps-with-intrusive-pooled-orders-matrix.html`](0004-use-flat-price-level-maps-with-intrusive-pooled-orders-matrix.html).
