...
private:
  ...
  void match_buy(order_book&, const order_routing::new_order&, order_routing::types::quantity& remaining);
  void match_sell(order_book&, const order_routing::new_order&, order_routing::types::quantity& remaining);
