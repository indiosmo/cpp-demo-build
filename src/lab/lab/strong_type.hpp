#ifndef LAB_STRONG_TYPE_HPP
#define LAB_STRONG_TYPE_HPP
 ...
 * lab::strong_type keeps the skill spelling while owning construction,
 * comparison, and formatting policy locally.
 */
template <typename T, typename Parameter, template <typename> class... Skills>
struct FunctionCallable<lab::strong_type<T, Parameter, Skills...>>
  : crtp<lab::strong_type<T, Parameter, Skills...>, FunctionCallable>
{
...
template <typename T, typename Parameter, template <typename> class... Skills>
struct MethodCallable<lab::strong_type<T, Parameter, Skills...>>
  : crtp<lab::strong_type<T, Parameter, Skills...>, MethodCallable>
{
...
template <typename T, typename Parameter, template <typename> class... Skills>
struct Dereferencable<lab::strong_type<T, Parameter, Skills...>>
  : crtp<lab::strong_type<T, Parameter, Skills...>, Dereferencable>
{
...
struct Factory : crtp<T, Factory>
{
  ...
  template <typename... Args>
    requires(lab::is_fixed_string_v<typename T::UnderlyingType>)
  static lab::result<T> from(Args&&... args)
  {
...
namespace std {
template <typename T, typename Parameter, template <typename> class... Skills>
struct hash<lab::strong_type<T, Parameter, Skills...>>
{
  [[nodiscard]] std::size_t operator()(const lab::strong_type<T, Parameter, Skills...>& x) const noexcept
  {
...
template <typename T, typename Parameter, template <typename> class... Skills>
struct fmt::formatter<lab::strong_type<T, Parameter, Skills...>>
{
  ...
  auto format(const lab::strong_type<T, Parameter, Skills...>& val, FormatContext& ctx) const
  {
    return fmt::format_to(ctx.out(), "{0}", val.get());
  }
};

#endif /* LAB_STRONG_TYPE_HPP */
