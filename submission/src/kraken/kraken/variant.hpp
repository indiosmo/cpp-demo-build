#ifndef KRAKEN_VARIANT_HPP
#define KRAKEN_VARIANT_HPP

#include "kraken/overload.hpp"
...
{
  return std::variant<kraken::nested_type_t<std::variant_alternative_t<I, Variant>, NestedType>...>{};
}
...
#define KRAKEN_PLUCK(variant, field) kraken::match(variant, [](const auto& x) { return x.field; })

#endif /* KRAKEN_VARIANT_HPP */
