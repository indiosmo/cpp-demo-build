#ifndef KRAKEN_NETWORK_EF_VI_UDP_RECEIVER_HPP
#define KRAKEN_NETWORK_EF_VI_UDP_RECEIVER_HPP
...
public:
  ...
  /* Stub: returns kraken::error_code::not_implemented. */
  kraken::result<void> open();
   ...
   */
  kraken::inplace_function<void(types::datagram_view)> on_datagram;
...
#endif /* KRAKEN_NETWORK_EF_VI_UDP_RECEIVER_HPP */
