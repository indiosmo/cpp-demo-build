#ifndef KRAKEN_ASSERT_HPP
#define KRAKEN_ASSERT_HPP
...
#ifdef NDEBUG
#define KRAKEN_ABORT() (void)0
#else
#define KRAKEN_ABORT() std::abort()
#endif

#define KRAKEN_ASSERT(expr)                                                                             \
