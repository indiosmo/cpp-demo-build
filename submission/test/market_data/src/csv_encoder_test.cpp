 ...
 * expected records come from EXERCISE.md and the recorded black-box scenarios:
 * comma-space separated fields, "B"/"S" side tokens, and "-" for an
 * eliminated top-of-book side.
 */
