...
using equality_only = kraken::strong_type<EqualityOnly, struct EqualityOnlyTag>;
using pair_id = kraken::strong_type<Pair, struct PairTag>;
using quantity = kraken::strong_type<int, struct QuantityTag>;
using price = kraken::strong_type<int, struct PriceTag>;
